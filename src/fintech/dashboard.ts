import { api, APIError, STATUS_LABEL, formatNaira, type Customer, type Transfer } from './lib/api'
...
const listEl = document.getElementById('customer-list') as HTMLElement
const detailPanel = document.getElementById('detail-panel') as HTMLElement
const emptyState = document.getElementById('empty-state') as HTMLElement
const detailHeader = document.getElementById('detail-header') as HTMLElement
const kycAlertBanner = document.getElementById('kyc-alert-banner') as HTMLElement
const triggerVerifyBtn = document.getElementById('trigger-verify-btn') as HTMLButtonElement

const tabWithdraw = document.getElementById('tab-withdraw') as HTMLButtonElement
const tabKyc = document.getElementById('tab-kyc') as HTMLButtonElement
const viewWithdraw = document.getElementById('view-withdraw') as HTMLElement
const viewKyc = document.getElementById('view-kyc') as HTMLElement
const kycDetailsCard = document.getElementById('kyc-details-card') as HTMLElement
...
const transferResult = document.getElementById('transfer-result') as HTMLElement
const historyEl = document.getElementById('transfer-history') as HTMLElement

const presetSelfBtn = document.getElementById('preset-withdraw-self') as HTMLButtonElement
const presetMismatchBtn = document.getElementById('preset-withdraw-mismatch') as HTMLButtonElement
...
function renderList() {
  ...
  listEl.querySelectorAll<HTMLButtonElement>('.customer-row').forEach((btn) => {
...
async function renderDetail() {
  ...
  // Wire header buttons
  const rekycBtn = document.getElementById('rekyc-btn') as HTMLButtonElement
...
function renderKycTabView(customer: Customer) {
...
function showKycModal(customer: Customer) {
  ...
  document.getElementById('modal-approve-btn')?.addEventListener('click', async () => {
    const btn = document.getElementById('modal-approve-btn') as HTMLButtonElement
    btn.disabled = true
  ...
  document.getElementById('modal-reject-btn')?.addEventListener('click', async () => {
    const btn = document.getElementById('modal-reject-btn') as HTMLButtonElement
    btn.disabled = true
...
// Amount chips
document.querySelectorAll<HTMLButtonElement>('.preset-chip[data-amt]').forEach((chip) => {
...
transferForm.addEventListener('submit', async (e) => {
  ...
  try {
    const res = await api.requestTransfer(selectedId, {
      ...
      recipient_bank: (document.getElementById('t_bank') as HTMLSelectElement).value,
...
async function loadTransfers(customerId: string) {
