...
import { buildLanguageSnippets, LOOKUP_CALL, VERIFY_REGISTRATION_CALL } from './lib/apiExamples.js';
import { showErrorModal } from './lib/modal.js';

function callTabs(call, mode) {
...
const underageBtn = document.getElementById('simulate-underage-btn');
const presetAdultBtn = document.getElementById('btn-preset-adult');
...
const bulkNinsInput = document.getElementById('bulk-nins-input');
...
const mismatchBtn = document.getElementById('btn-preset-mismatch');
