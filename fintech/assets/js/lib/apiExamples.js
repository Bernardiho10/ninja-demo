...
function goExample(body) {
    ...
    if (body.dateOfBirth)
        fields.push(`DateOfBirth: "${body.dateOfBirth}", // typed at onboarding, not looked up first`);
...
function buildLanguageSnippets(example) {
    return {
...
export { ONBOARD_CALL, buildLanguageSnippets, curlExample, goExample, javascriptExample, nodeExample, pythonExample };
